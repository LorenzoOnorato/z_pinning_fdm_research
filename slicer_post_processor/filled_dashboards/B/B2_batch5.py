...
stagger_params = {
    ...
    "fixed_start_layers": [14 * 2, 7 * 2],  # Specific starting layers for pins
}
...
def main():
    ...
    parts_on_build_plate = [
        {
            'name': 'part_1',
            'xy': (24 + 7 * 0 + x_shift, 27.5 + y_shift),
            'rotation': 90.0
        },
        {
            'name': 'part_2',
            'xy': (24 + 7 * 1 + x_shift, 27.5 + y_shift),
            'rotation': 90.0
        },
        {
            'name': 'part_3',
            'xy': (24 + 7 * 2 + x_shift, 27.5 + y_shift),
            'rotation': 90.0
        },
        {
            'name': 'part_4',
            'xy': (24 + 7 * 3 + x_shift, 27.5 + y_shift),
            'rotation': 90.0
        },
        {
            'name': 'part_5',
            'xy': (24 + 7 * 4 + x_shift, 27.5 + y_shift),
            'rotation': 90.0
        },
    ]
