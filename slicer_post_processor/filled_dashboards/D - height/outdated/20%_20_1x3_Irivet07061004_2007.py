...
stagger_params = {"start_layer_offset": 7,  # Offset to apply between successive pins
                  "fixed_start_layers": [20, 13, 6],  # Specific starting layers for pins
                }
